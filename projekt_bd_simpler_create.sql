...
-- Table: reservation_conference_days
CREATE TABLE reservation_conference_days (
    reservation_day_id int  NOT NULL,
    conference_day_id int  NOT NULL,
    reservation_id int  NOT NULL,
    CONSTRAINT reservation_conference_days_pk PRIMARY KEY  (reservation_day_id)
);

-- Table: reservation_workshops
CREATE TABLE reservation_workshops (
    reservation_workshop_id int  NOT NULL,
    reservation_day_id int  NOT NULL,
    attendee_id int  NOT NULL,
    workshop_id int  NOT NULL,
    CONSTRAINT reservation_workshops_pk PRIMARY KEY  (reservation_workshop_id)
);
...
ALTER TABLE conference_day_attendees ADD CONSTRAINT conference_day_attendees_reservation_conference_day
    ...
    REFERENCES reservation_conference_days (reservation_day_id);
...
-- Reference: reservation_conference_day_conference_days (table: reservation_conference_days)
ALTER TABLE reservation_conference_days ADD CONSTRAINT reservation_conference_day_conference_days
    FOREIGN KEY (conference_day_id)
    REFERENCES conference_days (conference_day_id);

-- Reference: reservation_conference_day_reservation (table: reservation_conference_days)
ALTER TABLE reservation_conference_days ADD CONSTRAINT reservation_conference_day_reservation
    FOREIGN KEY (reservation_id)
    REFERENCES reservations (reservation_id);
...
-- Reference: reservation_workshop_reservation_conference_day (table: reservation_workshops)
ALTER TABLE reservation_workshops ADD CONSTRAINT reservation_workshop_reservation_conference_day
    FOREIGN KEY (reservation_day_id)
    REFERENCES reservation_conference_days (reservation_day_id);

-- Reference: reservation_workshop_workshops (table: reservation_workshops)
ALTER TABLE reservation_workshops ADD CONSTRAINT reservation_workshop_workshops
...
ALTER TABLE workshop_attendees ADD CONSTRAINT workshop_attendees_reservation_workshops
    ...
    REFERENCES reservation_workshops (reservation_workshop_id);
